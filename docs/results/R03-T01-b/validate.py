...
INPUT_SHA = '0f114284492417ec61634895c485d73417ff1b49'
...
def main() -> int:
    ...
    manifest = dict(task_id='R03-T01-b', input_sha=INPUT_SHA, product_source_sha=INPUT_SHA,
        plan_sha=None, context_plan_sha=git('rev-parse', 'origin/integration/r03'),
        plan_manifest_sha256='3b5f1fdf74e2c236768216d27edbd1bffa67bb57577c21c2b38504d6edac7d2c',
        planning_files_verified=26, tested_code_sha=sha, branch=git('branch','--show-current'),
        ...
        out_of_scope_diff=git('diff','--name-only',INPUT_SHA,'--','game/core','game/runtime','game/desktop','tests','scripts','packaging','.github','docs/results/R03-T01-a'),
        dependency_security='Unchanged hash lock; see R03-T01-a/dependency-security.json for prior advisory snapshot', decisions_status=json.loads((OUT/'decisions.json').read_text())['status'],
        desktop_baseline='See desktop-validation.json; isolated copy of unchanged input, not rooms-1.1 decoder acceptance',
